import { Validator, ValidatorConfig } from '@core/scripts/validation';
import { DwgElement } from '@core/components/dwg_element';
import { DwgForm } from '../form';
...
export abstract class DwgFormField<T extends HTMLElement, R> extends DwgElement {
  ...
  constructor() {
    ...
    this.classList.add('dwg-form-field');
  }
  ...
  protected override fullyParsedCallback(): void {
    if (this.ran_parsed_callback) {
      ...
      console.error('Do not override parsedCallback in DwgFormField');
    }
  }
