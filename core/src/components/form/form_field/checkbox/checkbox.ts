import { DwgFormField, formFieldChangeEvent } from '../form_field';

import html from './checkbox.html';

import './checkbox.scss';

export class DwgCheckbox extends DwgFormField<HTMLInputElement, boolean> {
  constructor() {
    super();
...
customElements.define('dwg-checkbox', DwgCheckbox);

declare global {
  interface HTMLElementTagNameMap {
    'dwg-checkbox': DwgCheckbox;
  }
}
