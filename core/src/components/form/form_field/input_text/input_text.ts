import { DwgFormField } from '../form_field';
import { defaultMapping, specificMapping } from '@core/scripts/datalists';

import html from './input_text.html';

import './input_text.scss';

export class DwgInputText extends DwgFormField<HTMLInputElement, string> {
...
customElements.define('dwg-input-text', DwgInputText);

declare global {
  interface HTMLElementTagNameMap {
    'dwg-input-text': DwgInputText;
  }
}
