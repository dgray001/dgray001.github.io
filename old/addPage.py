...
f.write('const {until} = await import(`/scripts/util.js?v=${version}`);\n')
f.write('\n')
f.write("const styles = document.createElement('link');\n")
f.write("styles.setAttribute('rel', 'stylesheet');\n")
f.write(f'styles.setAttribute(\'href\', `./styles.css?v=${{version}}`);\n')
f.write('document.head.appendChild(styles);\n')
f.write('\n')
f.write("const stylesheet = document.createElement('link');\n")
f.write("stylesheet.setAttribute('rel', 'stylesheet');\n")
f.write(f'stylesheet.setAttribute(\'href\', `./{name}/{filename}.css?v=${{version}}`);\n')
...
f.write('\n')
f.write("const recaptcha = document.createElement('script');\n")
f.write("recaptcha.setAttribute('src', 'https://www.google.com/recaptcha/api.js');\n")
f.write('document.head.appendChild(recaptcha);\n')
f.write('\n')
f.write(f'await import(`/scripts/page_layout_components.js?v=${{version}}`);\n')
f.write(f'const {{onInit}} = await import(`./{filename}.js?v=${{version}}`);\n')
f.write('await until(() => document.readyState === \'complete\');\n')
f.write('onInit();')
f.close()
