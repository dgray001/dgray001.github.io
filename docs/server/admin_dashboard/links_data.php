...
if (!hasPermission('links', $_SESSION["user_role"])) {
  echo json_encode(array(
    'success' => false,
    'error_message' => 'You don\'t have permission to modify links data',
  ));
  exit(1);
}
