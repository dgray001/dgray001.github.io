export class CufNavigationPane extends HTMLElement {
  ...
  async connectedCallback() {
    ...
    apostolic_activities_dropdown.addEventListener('mouseover', (e) => {
      apostolic_activities.setAttribute('style', 'box-shadow: inset 0 calc(var(--fixed-header-height)) 0 0 var(--navigation-hover-color);');
    ...
    apostolic_activities_dropdown.addEventListener('mouseleave', (e) => {
      apostolic_activities.setAttribute('style', 'box-shadow: inset 0 0 0 0 var(--navigation-hover-color);');
