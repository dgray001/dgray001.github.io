...
export class SjfResetPasswordForm extends DwgForm<ResetPasswordFormData> {
...
customElements.define('sjf-reset-password-form', SjfResetPasswordForm);

declare global {
  interface HTMLElementTagNameMap {
    'sjf-reset-password-form': SjfResetPasswordForm;
  }
}
