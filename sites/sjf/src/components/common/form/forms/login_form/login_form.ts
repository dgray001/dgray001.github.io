...
/** Data describing the login form */
export declare interface LoginFormData {
  username: string;
  password: string;
}

export class SjfLoginForm extends DwgForm<LoginFormData> {
...
customElements.define('sjf-login-form', SjfLoginForm);

declare global {
  interface HTMLElementTagNameMap {
    'sjf-login-form': SjfLoginForm;
  }
}
